...
Lcm_init = Variable(th.from_numpy((init_param1 * Lcm_raw).astype(np.float64).reshape([1,1,1600,1600])).cuda())
Lmat = Variable(th.from_numpy(Lmat_raw.astype(np.float64).reshape([1,1,1600,1600])).cuda())
Lmat_init = Variable(th.from_numpy((init_param2 * Lmat_raw).astype(np.float64).reshape([1,1,1600,1600])).cuda())
Luu = Variable(th.from_numpy(Luu_raw.astype(np.float64).reshape([1,1,1600,1600])).cuda())
Luu_init = Variable(th.from_numpy((init_param3 * Luu_raw).astype(np.float64).reshape([1,1,1600,1600])).cuda())
